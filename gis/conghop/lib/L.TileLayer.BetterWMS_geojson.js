L.TileLayer.BetterWMS = L.TileLayer.WMS.extend({
  ...
  showGetFeatureInfo: function (err, latlng, content) {
    ...
    // var noidung='';
    // noidung+='<h2>Thông tin trạm thủy văn</h2>';
    // noidung+='<hr>';
	// noidung+='<b>Tên trạm</b>: '+name+'<br>';
	// noidung+='<b>Đất nước</b>: '+country+'<br>';
    // noidung+='<b>Mưa TB tháng 1</b>: '+t1ave+'<br>';
    // noidung+='<b>Mưa Min tháng 1</b>: '+t1min+'<br>';
    // noidung+='<b>Mưa Max tháng 1</b>: '+t1max+'<br>';
