L.TileLayer.BetterWMS = L.TileLayer.WMS.extend({
  ...
  showGetFeatureInfo: function (err, latlng, content) {
   ...
   if(lyr=='bandothuyvan:congtrinhconghop'){
		var res_obj = JSON.parse(content);
		t1 =  res_obj;
		var ten=t1.features[0].properties.name;
   ...
   if(lyr=='bandothuyvan:congtrinhcongtron'){
		var res_obj = JSON.parse(content);
		t1 = res_obj;
		var ten=t1.features[0].properties.name;
		var lytrinh=t1.features[0].properties.lytrinh;
	...
	if(lyr=='bandothuyvan:trambom_4326'){
		var res_obj = JSON.parse(content);
		t1 = res_obj;
		var ten=t1.features[0].properties.name;
   ...
   if(lyr=='bandothuyvan:ranhgioihc'){
		var res_obj = JSON.parse(content);
		t1 = res_obj;
